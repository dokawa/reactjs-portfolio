		...
		return (
			<div class="android-app-wrapper">
				...
				<div class="android-app-description">
					...
					<div class="android-app-text"> Detalhes da “Play Store”: { this.props.rating_info[2] } usuários ativos mais de  { this.props.rating_info[3] } downloads - Dados de 01/2019 – descomissionado desde então { this.buildTextFromLinebreaker(this.props.description) }</div>
				</div>
