...
class WallpaperLeague extends Component {
	...
	render() {
		return (
			<AndroidApp title = { this.state.title } year = { this.state.year } description = { this.state.description } image_list = { [MainScreenScreenshot, CharacterWallpaperScreenshot, CharacterWallpaperEditScreenshot] } rating_info = { [4.6, 594, 985] } />
		);
	}
}
